...
public class HexUtils {
    ...
    //taken from https://github.com/Rosewood-Development/RoseGarden/blob/master/src/main/java/dev/rosewood/rosegarden/utils/HexUtils.java
    ...
    public static void sendMessage(CommandSender sender, String message) {
        sender.sendMessage(colorify(DeezItems.prefix + message));
    }
